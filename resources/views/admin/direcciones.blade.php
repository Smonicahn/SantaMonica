...
<table id="productos" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
        @foreach($mostrar as $direcciones)
                    <tr>
                         <td>
                         <label class="label">{{$direcciones['COD_DIRECCION']}}</label>
                         </td>
                         <td>
                         <label class="label">{{$direcciones['TIP_DIRECCION']}}</label>
                         </td>
                         <td>
                         <label class="label">{{$direcciones['NOM_DIRECCION']}}</label>
                         </td>
                        <td>
