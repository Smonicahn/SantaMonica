...
@csrf
<div class="card-body">
         <form  method="POST" action="/clientes/update/{{$mostrarArray['COD_CLIENTE']}}" id="frmnuevo" name="frmnuevo" class="needs-validation"  enctype="multipart/form-data" novalidate>
         @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="facturas" name="facturas" value= "{{$mostrarArray['FACTURA']}}" placeholder="Ingrese la factura"onkeyup="convertir('facturas'), this.value= LetrasEspacio(this.value)"required>
            </div>
